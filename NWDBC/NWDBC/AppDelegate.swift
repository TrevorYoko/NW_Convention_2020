...
class AppDelegate: UIResponder, UIApplicationDelegate, UNUserNotificationCenterDelegate {
    ...
    lazy var persistentContainer: NSPersistentContainer = {
         ...
         */
        let container = NSPersistentContainer(name: "NWDBCModel")
    ...
    private func doInitialization() {
        ...
        let containerViewController = AppContainerViewController.init()
    ...
    private func themeApplication() {
        UITabBar.appearance().tintColor = AppTheme.mainColor
        UINavigationBar.appearance().tintColor = AppTheme.mainColor
        UISegmentedControl.appearance().tintColor = AppTheme.mainColor
        UIButton.appearance().tintColor = AppTheme.mainColor
    }
